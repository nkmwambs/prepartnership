...
class Finance_model extends CI_Model {
	...
	public function prod_parameter_model() {
	...
	public function test_parameter_model() {
		$dashboard_params = array();
	...
	private function prod_mfr_submission_data_model() {
		$mfr_submission_data = array();

		$data = $this -> db -> get($this -> table_prefix . 'opfundsbalheader') -> result_array();
	...
	private function mfr_submission_data() {
		...
		if ($this -> config -> item('environment') == 'test') {
			...
			return $this -> prod_mfr_submission_data_model();
		}
