...
$parent_entitlement = $this->db->get_where("entitlement",array("derivative_id"=>0,"visibility"=>1))->result_object();
...
<div class="row">
	<div class="col-sm-12">
		...
		<a class="btn btn-primary" href="<?=base_url();?>settings/user_profiles">Back</a>
...
$("input:checkbox").click(function(){
	...
	var url = "<?=base_url();?>settings/update_entitlement/"+entitlement_id+"/"+profile_id+"/"+action;
